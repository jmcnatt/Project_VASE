 ...
 */
public class DeployWizardLinuxClientPanel extends Panel
{
	 ...
	 * Main Constructor
	 */
	public DeployWizardLinuxClientPanel()
	{
	...
	private void makeItems()
	{
		...
		jlBind = Utilities.createDeployComponentLabel("Bind to NIS: ");
		jlDirectoryName = Utilities.createDeployComponentLabel("Directory Name: ");
		jlLinuxClient = Utilities.createDeployLabel(DEPLOY_LINUX_CLIENT);
	...
	private void makePanels()
	{
		...
		southSouth.add(Utilities.createDeployLabel("Note: Ensure an NIS server is active before continuing"));
