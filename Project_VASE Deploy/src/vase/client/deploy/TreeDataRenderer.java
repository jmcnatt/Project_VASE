 ...
 * @see GuiMain
 */
public class TreeDataRenderer extends DefaultTreeCellRenderer implements ProjectConstraints
{
            ...
            boolean selected, boolean expanded, boolean leaf, int row, boolean hasFocus)
	{
		...
		if (value instanceof Datacenter)
		{
			...
			label.setIcon(new ImageIcon(getClass().getResource("/images/datacenter-icon.png")));
		}
		...
		else if (value instanceof Folder)
		{
			try
			{
				...
				if (expanded)
				{
					label.setIcon(new ImageIcon(getClass().getResource("/images/folder-icon-small-open.png")));
				}
				
				else
				{
					label.setIcon(new ImageIcon(getClass().getResource("/images/folder-icon-small-closed.png")));
				}
			}
		...
		else if (value instanceof VirtualMachine)
		{
			try
			{
				...
				if (parent.getName().equals(TEMPLATE_FOLDER))
				{
					label.setIcon(new ImageIcon(getClass().getResource("/images/template-icon-small.png")));
				}
				...
				else
				{
					...
					{
						label.setIcon(new ImageIcon(getClass().getResource("/images/vm-icon-small-poweredon.png")));
					}
					else
					{
						label.setIcon(new ImageIcon(getClass().getResource("/images/vm-icon-small.png")));
					}
				}
			}
		...
		else if (value instanceof VirtualApp)
		{
			...
			label.setIcon(new ImageIcon(getClass().getResource("/images/vapp-icon.png")));
		}
		
		else
		{
			label.setText(value.toString());
			label.setIcon(new ImageIcon(getClass().getResource("/images/blank.png")));
		}
