 ...
 */
public class LoginSplash extends GuiWindow implements ActionListener
{
	...
	private void makePanels()
	{
		...
		JLabel splashLabel = new JLabel(new ImageIcon(getClass().getResource("/images/splash.png")));
		jpNorth.setOpaque(false);
		jpNorth.setPreferredSize(DIM_MAIN_LOGIN_NORTH);
		jpNorth.setMaximumSize(DIM_MAIN_LOGIN_NORTH);
		jpNorth.setMinimumSize(DIM_MAIN_LOGIN_NORTH);
		...
		jpSouth.setMinimumSize(DIM_MAIN_LOGIN_SOUTH);
	...
	private void login()
	{
				...
				jtfPassword.getPassword().length == 0))
		{
			try
			{
				...
				LOG.write("Logged in as " + main.engine.getCurrentUsername() + " to " + 
	 ...
	 * @param event the actionevent, fired by the login button
	 */
