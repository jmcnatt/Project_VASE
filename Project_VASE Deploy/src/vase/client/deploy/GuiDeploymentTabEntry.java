 ...
 */
public class GuiDeploymentTabEntry extends JPanel implements GuiConstraints
{
	 ...
	 */
	public GuiDeploymentTabEntry(DeployedVirtualMachine deployed)
	{
		...
		setOpaque(false);
		setPreferredSize(DIM_MAIN_DEPLOYMENT_TAB_ENTRY);
		setMinimumSize(DIM_MAIN_DEPLOYMENT_TAB_ENTRY);
