...
public class TabbedPane extends JTabbedPane
{
	...
	private ImageIcon summary = new ImageIcon(getClass().getResource("/images/home-icon-title.png"));
	private ImageIcon vm = new ImageIcon(getClass().getResource("/images/vm-icon-title.png"));
	private ImageIcon deploy = new ImageIcon(getClass().getResource("/images/deployment-icon-title.png"));
	private ImageIcon log = new ImageIcon(getClass().getResource("/images/system-icon-title.png"));
	private ImageIcon help = new ImageIcon(getClass().getResource("/images/help-icon-title.png"));
