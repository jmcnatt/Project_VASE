		...
		throws IOException
	{
		...
		for (DeployedVirtualMachine each : deployed)
		{
			...
			if (each.isAccounts())
			{
				...
				{
					ProjectConstraints.LOG.write(each.getVmName() + ": CSV file #" + each.getAccountsCSV()+ " not formatted correctly", true);
				...
				{
					ProjectConstraints.LOG.write(each.getVmName() + ": CSV file not found for report generation", true);
					ProjectConstraints.LOG.printStackTrace(e);
				...
				{
					ProjectConstraints.LOG.write(each.getVmName() + ": Error reading csv for report generation", true);
					ProjectConstraints.LOG.printStackTrace(e);
			...
			if (each.getOsCategory().equals(ProjectConstraints.WINDOWS))
			{	
				writer.println("<tr>");
				writer.println("<td>");
				...
				writer.println("</td>");
				writer.println("<td>");
				writer.println(ProjectConstraints.DEFAULT_WINDOWS_PASSWORD);
				writer.println("</td>");
				writer.println("</tr>");
			}
			...
			{
				writer.println("root&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + ProjectConstraints.DEFAULT_LINUX_PASSWORD);
			}
