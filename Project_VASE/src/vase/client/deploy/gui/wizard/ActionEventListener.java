...
public class ActionEventListener implements ActionListener, ProjectConstraints
{
	 ...
	 * @param main
	 */
	public ActionEventListener(DeployWizard main)
	{
		this.main = main;
	 ...
	 * @see ActionEventListener#actionPerformed(ActionEvent)
	 */
	private void next(String state)
	{
		...
		if (state.equals(CenterPanel.WELCOME))
		{
			...
			main.center.show(CenterPanel.SELECTOS);
			main.center.osPanel.jcbCategory.requestFocus();
		}
		
		else if (state.equals(CenterPanel.SELECTOS))
		{
			...
			main.updateSubTitleLabel(true);
			main.center.show(CenterPanel.GUEST_INFO);
			main.center.guestInfoPanel.jtfVMName.requestFocusInWindow();
		}
		
		else if (state.equals(CenterPanel.GUEST_INFO))
		{
			//Validate this form
			...
			else
			{
				...
				if (main.chosenOSCategory.equals(WINDOWS))
				{
					...
					{
						main.center.show(CenterPanel.WIN_CLIENT);
					}
				
					else if (main.chosenOSType.equals(SERVER))
					{
						main.center.show(CenterPanel.WIN_SERVER);
					}
				}
						...
						|| main.chosenOSCategory.equals(BSD))
				{
					if (main.chosenOSType.equals(CLIENT))
					{
						main.center.show(CenterPanel.LINUX_CLIENT);
					}
				
					else if (main.chosenOSType.equals(SERVER))
					{
						main.center.show(CenterPanel.LINUX_SERVER);
					}
				}
		...
		else if (state.equals(CenterPanel.WIN_CLIENT) || state.equals(CenterPanel.WIN_SERVER) ||
				state.equals(CenterPanel.LINUX_CLIENT) || state.equals(CenterPanel.LINUX_SERVER))
		{
			...
			else
			{
				...
				if (main.osNumber == main.osTotal)
				{
					...
					main.center.show(CenterPanel.SUMMARY);
