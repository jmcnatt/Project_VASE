...
public class CenterPanel extends Panel
{
	...
	private void makeItems()
	{
		...
		windowsClientPanel = new WindowsClientPanel();
		windowsServerPanel = new WindowsServerPanel();
		linuxClientPanel = new LinuxClientPanel();
		linuxServerPanel = new LinuxServerPanel();
