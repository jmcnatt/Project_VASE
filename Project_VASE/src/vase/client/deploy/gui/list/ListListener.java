/**
 * Project_VASE Deploy GUI list package
 */
package vase.client.deploy.gui.list;
...
import vase.client.deploy.menu.PopupMenuTemplate;
import vase.client.deploy.menu.PopupMenuVM;
...
public class ListListener extends MouseAdapter implements ListSelectionListener
{
	 ...
	 */
	public ListListener(List jlTemplates, List jlVMs, Main main)
	{
		this.main = main;
		this.jlVMs = jlVMs;
