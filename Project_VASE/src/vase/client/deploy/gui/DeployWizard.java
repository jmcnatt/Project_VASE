...
import vase.client.deploy.gui.wizard.ActionEventListener;
import vase.client.deploy.gui.wizard.CenterPanel;
import vase.client.deploy.gui.wizard.ItemEventListener;
import vase.client.deploy.gui.wizard.NorthPanel;
import vase.client.deploy.gui.wizard.SouthPanel;
 ...
 */
public class DeployWizard extends Dialog
{
	 ...
	 */
	public ActionEventListener actionListener;
	
	/**
	 * Main Item Listener
	 */
	public ItemEventListener itemListener;
	 ...
	 */
	public DeployWizard(Main window, int mode, Template template)
	{
	...
	private void makeItems()
	{
		...
		itemListener = new ItemEventListener(this);
	...
	private void setStartingScreen()
	{
		...
		switch (mode)
		{
			case SINGLE_VM_MODE:
			{
				...
				center.show(CenterPanel.SELECTOS);
				break;
			}
			...
			case TEMPLATE_VM_MODE:
			{
				...
				updateSubTitleLabel(true);
				center.show(CenterPanel.GUEST_INFO);
			...
			{
				stepTotal = 4;
				center.show(CenterPanel.WELCOME);
				south.jbNext.setEnabled(true);
				break;
			}
		}
