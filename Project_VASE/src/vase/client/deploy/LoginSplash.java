...
public class LoginSplash extends Window implements ActionListener
{
	...
	private void makeItems()
	{
		...
		jtfServer = (JTextField) Utilities.createMainTextField(ProjectConstraints.SETTINGS_READER.lastServer);
		jtfUsername = (JTextField) Utilities.createMainTextField(ProjectConstraints.SETTINGS_READER.lastUser);
	...
	private void makePanels()
	{
		...
		JLabel splashLabel = new JLabel(new ImageIcon(getClass().getResource("/images/deploy/splash.png")));
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		{
			new HelpWindow("Project_VASE Deploy Help", "/html/deploy/getting_started.html", ProjectConstraints.LOG);
		}
	}	
}
